<script setup lang="ts">
    ...
    const deleteData = () => {
        ...
        const index = categoriesData.data.findIndex((category: any) => category.id === deleteId.value)
        if (index !== -1) {
            categoriesData.data.splice(index, 1)
        }
          ...
          <CardBoxModal v-model="isModalDangerActive" title="Warning" button="danger" :onConfirm="deleteData" buttonLabel="Delete" has-cancel>
            ...
            <div class="flex">
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <tr v-for="(category, index) in categoriesData.data" :key="category.id" class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
