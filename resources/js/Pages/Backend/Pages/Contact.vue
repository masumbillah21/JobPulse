            ...
            <CardBox class="w-full" is-form @submit.prevent="save">
                ...
                <div class="flex">
                    <CardBox class="w-9/12">
                        <div class="flex">
                          <FormField class="w-1/2" label="Email" help="Enter Page Title">
                              <FormControl v-model="form.title" type="text" placeholder="Enter Page Title" />
                          </FormField>
                          <FormField class="w-1/2 lg:ml-1" label="Phone" help="Enter Page Title">
                              <FormControl v-model="form.title" type="text" placeholder="Enter Page Title" />
                          </FormField>
                        </div>
                        <FormField label="Address" help="Enter Page Title">
                            <FormControl v-model="form.title" type="text" placeholder="Enter Page Title" />
                        </FormField>
                    </CardBox>
