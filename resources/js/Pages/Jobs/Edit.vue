<script setup lang="ts">
    ...
    const jobData = usePage().props.job ?? null
    ...
    <template>
      <LayoutAuthenticated>
        ...
        <SectionMain>
            <SectionTitleLineWithButton :icon="mdiArrowRightCircle" :title="jobData !== null ? 'Edit job' : 'Create job'" main>
                <BaseButtonLink
            ...
            <div class="flex justify-center items-center">
                ...
                <FormField label="Responsibilities" label-for="responsibilities" help="Please enter job responsibilities">
                    <FormControl
                ...
                <BaseButtons>
                    <BaseButtonLink
                        type="submit"
                        color="info"
                        :label="jobData !== null ? 'Update' : 'Create'"
