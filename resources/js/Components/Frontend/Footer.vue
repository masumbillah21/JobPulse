...
<template>
  <footer class="relative pt-8 pb-6 bg-white dark:bg-slate-800">
    <shape polygonClass="dark:text-slate-800 text-white" />
        ...
        <div class="w-full lg:w-6/12 px-4">
          <div class="flex flex-wrap items-top mb-6">
            <div class="w-full lg:w-4/12 px-4 ml-auto">
              <span class="block uppercase dark:text-gray-100 text-gray-700 text-sm font-semibold mb-2">Useful Links</span>
